...
contract('NeverPayShares', (accounts) => {
    ...
    it("Test that the investor can't transfer more shares than they currently own", async () => {
        ...
        await truffleAssert.reverts(NeverPayShares.transfer(accounts[3], 1000, {from: accounts[2]}));
    })
})