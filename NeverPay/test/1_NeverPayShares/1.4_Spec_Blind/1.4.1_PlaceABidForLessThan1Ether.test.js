...
contract('NeverPayShares', (accounts) => {
    ...
    let investorBidInformation = InvestorLogic.getBidHash(0.0001, 0.1);
    let bidHash = investorBidInformation.hash;

    it("Test that NeverPayShares cannot identify bid information due to keccak256 one-way hashing", async () => {
        ...
        assert.equal(bidInformation.id, investor, "Investor's bid was not successfully placed, despite it being valid");
    })
})