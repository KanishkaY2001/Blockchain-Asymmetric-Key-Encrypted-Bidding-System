...
contract('NeverPayShares', (accounts) => {
    ...
    it("Test that NeverPayShares maps the investor's bid to their address, to track their bids", async () => {
        ...
        assert.equal(bidInformation.id, investor, "Investor's bid does not correlate (map) with their address");
    })
})