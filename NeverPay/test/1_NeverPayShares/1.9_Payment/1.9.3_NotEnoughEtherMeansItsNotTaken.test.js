...
contract('NeverPayShares', (accounts) => {
    ...
    it("Test that if not enough Ether is provided, that their Ether is not taken", async () => {
        ...
        await truffleAssert.reverts(NeverPayShares.purchaseShares(shares, price, nonce, nonce, {from: investor, value: valueOfSharesInWei - 2000}));
    })
})