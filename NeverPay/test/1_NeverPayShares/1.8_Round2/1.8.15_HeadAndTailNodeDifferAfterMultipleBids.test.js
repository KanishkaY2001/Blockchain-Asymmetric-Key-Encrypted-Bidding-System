...
contract('NeverPayShares', (accounts) => {
    ...
    it("Test that the head and tail nodes are not the same after more than 1 bid exists", async () => {
        ...
        assert.notEqual(headNode, tailNode, "Despite having more than a single node, the tail and head nodes are the same. Linked list does not work")
    })
})