...
contract('NeverPayShares', (accounts) => {
    ...
    it("Test that the lowest valid bidder can claim shares", async () => {
        ...
        let validBidder = investorBidInformationArray[3];
        let validBidHash = validBidder.hash;
        let validInvestor = accounts[5];
        ...
        assert.notEqual(sharesBalance.words[0], 0, "Investor did not receive shares");
    })
})