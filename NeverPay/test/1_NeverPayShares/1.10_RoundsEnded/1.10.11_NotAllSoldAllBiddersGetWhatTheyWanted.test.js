...
contract('NeverPayShares', (accounts) => {
    ...
    it("Test that all bidders get the shares they wanted to purchase, when not all shares sold", async () => {
        ...
        for (let numberOfInvestors = 0; numberOfInvestors < totalInvestors; ++numberOfInvestors) {
            ...
            let investorBidInformation = InvestorLogic.getBidHash(100, 1 + numberOfInvestors);
