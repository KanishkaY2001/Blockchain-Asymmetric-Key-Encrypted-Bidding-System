...
contract('NeverPayShares', (accounts) => {
    ...
    it("Test that a valid bidder, higher than lowest valid bid, can claim shares", async () => {
        ...
        let sharesBalance = NeverPayShares.balanceOf(validInvestor, {from: validInvestor});
        assert.notEqual(sharesBalance, 0, "Investor did not receive shares");
    })
})