...
contract('NeverPayShares', (accounts) => {
    ...
    it("Test that first investor claiming shares will find lowest valid bid", async () => {
        ...
        let lowestValidBid = await NeverPayShares.lowestValidBid({from: investor});
        
        assert.notEqual(lowestValidBid, 0, "LowestValidBid has not been found, which goes against intended design")
    })
})